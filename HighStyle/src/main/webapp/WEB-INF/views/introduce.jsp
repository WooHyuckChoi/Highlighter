...
<!-- nav끝 -->
	...
	<div style="width: 50%; margin: 0 auto;">
		<div id="div1">
			 <h1>부모 이용방법</h1>
			 <br/>
			 <img src="./resources/img/parents1.PNG">
			 <br/>
			 <img src="./resources/img/parents2.PNG">
			 <br/>
			 <img src="./resources/img/parents3.PNG">
			 <br/>
		</div>
	</div>
		<!-- 로그인 전 끝 -->
