...
<body>
	...
	$("#classGoIn").click(function(){
					...
					$.ajax({
							...
							success : function(data) {
								if(data=="success"){
									...
									window.open("https://106.249.38.113:443/board.html?ext_id=${ext_id}&id=${user_id}"); //106.249.38.98,192.168.43.136 106.249.38.110 192.168.43.136
								}
							},
							error : function(data) {
								alert("실패!");
				...
				{
					window.open("https://106.249.38.113:443/board.html?ext_id=${ext_id}&id=${user_id}"); //192.168.51.19
				}
			});
