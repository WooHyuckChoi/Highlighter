...
<c:set var="ROOT" value="${pageContext.request.contextPath }"></c:set><!-- /Highlighter -->
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	...
	<video controls preload="auto"
		width="640" height="264" src="displayVideoFile?fileName=${dto.att_file }">
	</video>
	<video controls preload="auto"
		width="640" height="264" src="displayVideoFile2?fileName=${dto.att_file }">
	</video>
	<video controls preload="auto"
		width="640" height="264" src="video?fileName=${dto.att_file }">
	</video>
