				...
				<div class="col-md-3 md-margin-bottom-40">
					<ul class="list-group sidebar-nav-v1 margin-bottom-40" id="sidebar-nav-1">
						<li id="StudyRoom" class="list-group-item">
							<a href="/Highlighter/how_teacher"><i class="fa fa-bar-chart-o"></i> Teacher<br>강사</a>
						</li>
						<li class="list-group-item">
							<a href="/Highlighter/how_teacher"><i class="fa fa-user"></i> 강사 이용방법</a>
						</li>
						<li class="list-group-item">
							<a href="/Highlighter/how_teacher"><i class="fa fa-comments"></i> 과외 등록</a>
						</li>
						<li class="list-group-item">
							<a href="/Highlighter/how_teacher"><i class="fa fa-history"></i> 강사 평가</a>
						</li>
					</ul>
				</div>
				<!--End Left Sidebar-->
				...
				<div class="col-md-9">
					<div class="profile-body">
						...
						<div class="profile-bio">
							<div class="row">
								<div class="col-md-12">
									<h4><strong>1. 과외 등록</strong></h4>
								</div>
								<div class="col-md-12">
									<img alt="" src="">
								</div>
								<div class="col-md-12">
									<h4><strong>2. 등등</strong></h4>
								</div>
								<div class="col-md-12">
									<img alt="" src="">
								</div>
								<div class="col-md-12">
									<h4><strong>3. 등등</strong></h4>
								</div>
								<div class="col-md-12">
									<img alt="" src="">
								</div>
