...
<div id="lEcontainer">
	...
	<div id="sectionDivP">
	<section>
		<div class="headerFont">강의 자세히 보기</div>
		
		<div class="lEtutorDiv2">
			...
			<div class="lEtutorDiv-2">
				...
				<div class="lEtutorDivT lEtutorDivT1">과목 : </div>
				<div class="lEtutorDivT lEtutorDivT2">수강 횟수 : </div>
				<div class="lEtutorDivT lEtutorDivT1">지역 : ${list.class_poss_area}</div>
				<div class="lEtutorDivT lEtutorDivT2">평균 점수 : ${list.best_score}</div>
			</div>
		</div>
		<div id="lEtutorDivBeforeInfo2">
<c:forEach items="${list2}" var="list2">
			<div class="lEtutorDivBeforeInfoList2">
			...
			<div class="lEtutorDivBeforeInfoList2-1">
				<div>학부모 한 줄 평가</div>
				<div></div>
			</div>
			<div class="lEtutorDivBeforeInfoList2-2">
				<div>이전 강의 영상 확인</div>
				<div></div>
			</div>
			<div class="lEtutorDivBeforeInfoList2-3">
				<div>학생 성적 변화 확인하기</div>
				<div></div>
			</div>
		</div>
	</section>
