					...
					<div id="main-nav">
						<div class="nav-collapse collapse">
							<ul class="nav">
								...
								<li><a href="question_listAll">문의</a></li>
							</ul>
						</div>
					</div>
				</div>
...
<!-- nav끝 -->
	...
	<div style="width: 50%; margin: 0 auto;">
		<div id="div1">
			<!-- 과외 소개 및 강의 입장 타이틀 -->
			<div id="classIntro">문의 페이지</div>
			<div id="classIntro">이용 시 불편한점이나 궁금하신 사항있으시면 하단에 문의하기 버튼을 클릭하여
				질문 해주세요.</div>
			<!-- 과외 소개 및 강의 입장 타이틀 끝 -->
			<div>
				<table class="type07">
					<thead>
						<tr>
							<th scope="cols" style="width: 10px">NO.</th>
							<th scope="cols" style="width: 1000px">문의 내용</th>
					...
					<c:forEach items="${list}" var="QuestionVO">
						<tbody>
							<tr>
								...
								<th scope="row"><a href='/Highlighter/question_read?question_id=${QuestionVO.question_id}&user_name=${QuestionVO.user_name}'>${QuestionVO.question_title}</a></th>
				...
				<div class="box-footer" style="text-align: right">
					<button type="submit" class="btn btn-no-writer">문의하기</button>
				</div>
			</div>
		</div>
	</div>
          ...
          <div id="main-nav">
            <div class="nav-collapse collapse">
              <ul class="nav">
                ...
                <li><a href="index.html">사이트 소개</a> </li>
                <li><a href="/Highlighter/question_listAll">문의</a> </li>
              </ul>
            </div>
          </div>
        </div>
...
<div style="width: 50%; margin: 0 auto;">
		<div id="div1">
			...
			<div>
				...
				<div class="box-footer" style="text-align: right">
					<button type="submit" class="btn btn-writer">문의하기</button>
				</div>
			</div>
		</div>
	</div>
			  ...
			  success:function(data){
				  if(data == 0){
					...
					$("#user_pw").val('');
					  ...
					  $("#user_id").val('');
					  $("#user_pw").val('');
					  location.href="/Highlighter/question_listAll";
				  }
			  },
			  error:function(data){
				  alert("에러가 났스여!!!");
