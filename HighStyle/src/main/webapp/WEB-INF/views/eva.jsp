...
<body>
	...
	<div>
		...
		<h5 style = "opacity:0.7">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- 원하는 항목이 없으면 해당사항 없슴에 체크 해주시면 됩니다.</h5>
		<hr color="orange" width="810px">
	</div>
	<!-- 선택 박스 -->
	...
	<form name="form" method="post" action="eva_finish">
		<div class="my-box">
			...
			<p>
				...
				&nbsp;&nbsp;<input type="radio" name="foreigner" value="0" onclick="doOpenCheck2(this);" checked="checked">해당사항 없음.<br>
			</p>
			<p>
				...
				&nbsp;&nbsp;<input type="radio" name="style" value="0" onclick="doOpenCheck3(this);" checked="checked">해당사항 없음.<br>
			</p>
			<p>
				&nbsp;&nbsp;4. 원하는 강의 형태<br/>
				...
				&nbsp;&nbsp;<input type="radio" name="level1" value="0" onclick="doOpenCheck4(this);" checked="checked">해당사항 없음.<br>
			</p>
			<p>
				&nbsp;&nbsp;5. 원하는 강의 진도<br/>
				...
				<br><br>
				&nbsp;&nbsp;<input type="radio" name="student" value="0" onclick="doOpenCheck5(this);" checked="checked">해당사항 없음.
			</p>
			<p>
				&nbsp;&nbsp;6. 수화 강의<br/>
				&nbsp;&nbsp;<input type="radio" name="hand" value="1" onclick="doOpenCheck6(this);">나는 청각에 문제가 있어 수화강의를 듣고 싶어요.<br>
				&nbsp;&nbsp;<input type="radio" name="hand" value="0" onclick="doOpenCheck6(this);" checked="checked">해당사항 없음.<br>
			</p>			
		</div>
		<br><br>
		<div>
