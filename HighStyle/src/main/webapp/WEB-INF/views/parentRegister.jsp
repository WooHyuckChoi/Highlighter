...
<div class="nav-agency">
  <div class="navbar navbar-static-top">
    <div class="navbar-inner">
      <div class="container"> <a class="brand" href="/"> <img src="./resources/img/logo.png" alt=""></a>
        <div id="main-nav">
          ...
          <div class="con_fil">
           ...
           <div class="con_fil">
            ...
            <select name="user_grade">
            	...
            	<option value="parent" selected="selected">학부모</option>
            </select>
          </div>
          <div class="con_fil">
