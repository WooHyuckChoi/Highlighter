          ...
          <div class="span4  work-item graphics">
            ...
            <div class="sample work-item-image-container">
              <div class="work-item-overlay">
                <div class="inner">
                  <ul>
                    <li><a rel="prettyPhoto[gallery]" href="teacherRegister" class="gallery-btn">가입하기</a></li>
          ...
          <div class="span4  work-item nature">
            ...
            <div class="sample work-item-image-container">
              <div class="work-item-overlay">
                <div class="inner">
                  <ul>
                    <li><a rel="prettyPhoto[gallery]" href="studentRegister" class="gallery-btn">가입하기</a></li>
          ...
          <div class="span4  work-item food">
            ...
            <div class="sample work-item-image-container">
              <div class="work-item-overlay">
                <div class="inner">
                  <ul>
                    <li><a rel="prettyPhoto[gallery]" href="parentRegister" class="gallery-btn">가입하기</a></li>
