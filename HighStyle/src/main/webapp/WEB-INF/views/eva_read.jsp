...
<!--  -->
	...
	<div style="width: 50%; margin: 0 auto;">
		<div id="div1">
			<!-- 과외 소개 및 강의 입장 타이틀 -->
			<div id="classIntro"><strong>${user_name}</strong>님이 진행한 진단평가 체크 목록입니다. 수정 하시려면 아래쪽에 수정 버튼을 눌러주세요!!</div>
			<br><br>
			<div class ="my-box">
				<p>
					&nbsp;&nbsp;1. 참고서 및 교재 필요 여부<br/>
					<c:if test="${(EvaVO.book eq '1')}">
					&nbsp;&nbsp;나는 공책에 필기하는게 좋아요.<br>
					</c:if>
					<c:if test="${(EvaVO.book eq '2')}">
					&nbsp;&nbsp;책을 구매하는 비용이 부담스러워요.<br>
					</c:if>
				...
				<p>
					&nbsp;&nbsp;2. 외국인 강의<br/>
					<c:if test="${(EvaVO.foreigner eq '1')}">
					&nbsp;&nbsp;I want to hear the lecture in English(영어 : 나는 강의를 영어로 듣고 싶어요)<br>
					</c:if>
					<c:if test="${(EvaVO.foreigner eq '2')}">
					&nbsp;&nbsp;私は講義を日本語で聞きたい&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(일본어 : 나는 강의를 일본어로 듣고 싶어요)<br>
					</c:if>
				...
				<p>
					...
					<c:if test="${(EvaVO.style eq '1')}">
					&nbsp;&nbsp;수다스럽게 친구같은게 좋아요.<br>
					</c:if>
					<c:if test="${(EvaVO.style eq '2')}">
					&nbsp;&nbsp;편안하고 진중한게 좋아요.<br>
					</c:if>
					<c:if test="${(EvaVO.style eq '3')}">
					&nbsp;&nbsp;활기차고 즐거운게 좋아요.<br>
					</c:if>
				...
				<p>
					&nbsp;&nbsp;4. 원하는 강의 형태<br/>
					<c:if test="${(EvaVO.level1 eq '1')}">
					&nbsp;&nbsp;학교 수업이 너무 어렵고 따라가기 힘들어서 <strong>기초 강의</strong>가 필요해요.<br>
					</c:if>
					<c:if test="${(EvaVO.level1 eq '2')}">
					&nbsp;&nbsp;학교 수업이 어렵지만 조금은 이해가 되기 때문에 <strong>포괄적인 강의</strong>가 필요해요.<br>
					</c:if>
					<c:if test="${(EvaVO.level1 eq '3')}">
					&nbsp;&nbsp;학교 수업을 하면 전체적인 이해 하지만 <strong>교과서 중심</strong>의 강의가 필요해요.<br>
					</c:if>
					<c:if test="${(EvaVO.level1 eq '4')}">
					&nbsp;&nbsp;학교에서 남들 하는 만큼은 하기때문에 <strong>문제 풀이식 강의</strong>가 필요 해요.<br>
					</c:if>
					<c:if test="${(EvaVO.level1 eq '5')}">
					&nbsp;&nbsp;학교 수업이 이해가 쉽지만 더이상 올라가기는 힘들어서 <strong>쪽집계 강의</strong>가 필요해요.<br>
					</c:if>
					<c:if test="${(EvaVO.level1 eq '6')}">
					&nbsp;&nbsp;학교 수업이 쉬워 <strong>시험 대비용 강의</strong>가 필요해요.<br>
					</c:if>
				...
				<p>
					&nbsp;&nbsp;5. 원하는 강의 진도<br/>
					<c:if test="${(EvaVO.student eq '1')}">
					&nbsp;&nbsp;초등학교 1학년
					</c:if>
					<c:if test="${(EvaVO.student eq '2')}">
					&nbsp;&nbsp;초등학교 2학년
					</c:if>
					<c:if test="${(EvaVO.student eq '3')}">
					&nbsp;&nbsp;초등학교 3학년<br/>
					</c:if>
					<c:if test="${(EvaVO.student eq '4')}">
					&nbsp;&nbsp;초등학교 4학년
					</c:if>
					<c:if test="${(EvaVO.student eq '5')}">
					&nbsp;&nbsp;초등학교 5학년
					</c:if>
					<c:if test="${(EvaVO.student eq '6')}">
					&nbsp;&nbsp;초등학교 6학년
					</c:if>
					<c:if test="${(EvaVO.student eq '7')}">
					&nbsp;&nbsp;중학교 1학년
					</c:if>
					<c:if test="${(EvaVO.student eq '8')}">
					&nbsp;&nbsp;중학교 2학년
					</c:if>
					<c:if test="${(EvaVO.student eq '9')}">
					&nbsp;&nbsp;중학교 3학년
					</c:if>
					<c:if test="${(EvaVO.student eq '10')}">
					&nbsp;&nbsp;고등학교 1학년
					</c:if>
					<c:if test="${(EvaVO.student eq '11')}">
					&nbsp;&nbsp;고등학교 2학년
					</c:if>
				...
				<p>
					&nbsp;&nbsp;6. 수화 강의<br/>
					<c:if test="${(EvaVO.hand eq '1')}">
					&nbsp;&nbsp;나는 청각에 문제가 있어 수화강의를 듣고 싶어요.<br>
					</c:if>
