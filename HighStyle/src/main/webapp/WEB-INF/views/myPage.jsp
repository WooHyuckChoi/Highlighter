   ...
   <div id="classIndex" >
      <div id="classMain" >
         <ul class="MyPage">
            ...
            <li id="StudyHomework">정보수정</li>
            <li id="StudyClassData">수강 중인 과외</li>
            <li id="StudyStudyManagement">수강 완료 과외</li>
            <li id="StudyClassTest">수강 신청 목록</li>
            <li id="message">메시지 함</li>
            <li id="StudyClassDeval">트로피 / 뱃지</li>
         </ul>
      </div>
   </div>
<!-- 과외 정보 관리 NAV 끝 -->
