		...
		<div id="div1">
			...
			<div id="classIntro">
				...
				<c:if test="${user_grade eq 'teacher'}">
					<button id="devalResi">평가등록</button>
				</c:if>
			</div>
			<div id="user-profile-1" class="user-profile row">
      		 ...
      		 <c:if test="${empty jindanResiNot}">
               	 <div id="notExist"><br><br><br><br>등록된 진단평가가 없습니다</div>
             </c:if>
           <c:if test="${user_grade eq 'teacher'}">  
             <c:if test="${!empty jindanResiNot}">
             	<div id="notExist">
             	...
             	<img src="./resources/img/jindanimg.jpg"
					...
					<h3>진단평가 등록을 완료 했습니다</h3>
					<br>진단평가 실시 여부에 따라 수업진행에 도움이 됩니다.
					<br>
					<br>
					<br>
					<button id="studentResult">학생별 결과</button>
					</div>
						</div>
             ...
             <c:if test="${!empty jindanResiNot}">
             	...
             	<img src="./resources/img/jindanimg.jpg"
					...
					<br>
					<br>
					<button id="jindanstart">진단평가실시</button>
					</div>
						</div>
...
<!--  -->
	...
	<script>
		...
		$("#jindanstart").click(function(){
			window.location.href="/Highlighter/jindanStart?ext_id=${ext_id}&user_id=${user_id}";
		});
