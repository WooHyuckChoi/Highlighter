			...
			<div class="row">
				...
				<div class="col-md-9">
					<div class="profile-body">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" maxlength="20" placeholder="최대 20글자 까지 가능합니다!" id="form-field-1" name="question_title" value="${QuestionVO.question_title}" class="col-xs-10 col-sm-5" style="width: 570px; height: 30px" />
										</div>
									</div>
									<br>						
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea class="form-control" name="question_content" style="resize: none" rows="15" cols="78">${QuestionVO.question_content}</textarea>
										</div>
									</div>
									<hr>
								</div>
						...
						<br>
						<div class="form-group">
							<button id="noticeResi" type="submit" class="btn btn-primary">수정 완료</button>
							<button id="noticeResi" type="submit" class="btn btn-info">수정 취소</button>
						</div>
					</form>
					<!-- End Profile Content -->
				</div>
