							...
							<div class="page-content">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<form method="post" action="classDevalfinish?ext_id=${ext_id }&user_id=${user_id}" enctype="multipart/form-data" class="form-horizontal" role="form">
									<br>
									<table>
    <thead>
        <tr>
            <th style="width: 30%;">문제 내용</th>
            <th style="width: 13%;">매우 그렇다</th>
            <th style="width: 14%;">대체로 그렇다</th>
            <th style="width: 11%;">보통이다</th>
            <th style="width: 14%;">그렇지 않다</th>
            <th style="width: 18%;">매우 그렇지 않다</th>
        </tr>
    </thead>
    <tbody>
         <% int count=0; %>
		<c:forEach items="${jindancont}" var="jindancont">
        <tr>
            <td style="text-align: left;"> ${jindancont}</td>
            <td><input type="radio" name="chk_info<%=count%>" value="1"></td>
            <td><input type="radio" name="chk_info<%=count%>" value="2"></td>
            <td><input type="radio" name="chk_info<%=count%>" value="3"></td>
            <td><input type="radio" name="chk_info<%=count%>" value="4"></td>
            <td><input type="radio" name="chk_info<%=count%>" value="5"></td>
...
<![endif]-->
		...
		$("#classGoIn").click(function() {
			window.location.href="/Highlighter/classDeval?user_id=${id}&ext_id=${ext_id}";
		});
